...
doctor:
    @echo "Running diagnostics for k9-haskell..."
...
heal:
    @echo "Attempting auto-repair for k9-haskell..."
...
help-me:
    @echo "=== k9-haskell Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/k9-haskell/issues/new"
    @echo ""

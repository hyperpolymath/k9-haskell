...
// Replace k9-haskell, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= k9-haskell — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining k9-haskell for
...
* Upstream: https://github.com/hyperpolymath/k9-haskell/issues

...
// Replace k9-haskell, K9 Haskell — See README.adoc for details., just run, K9 Haskell started successfully. with actuals
= k9-haskell — Quick Start for Users
:toc:
:toclevels: 2

== What is k9-haskell?

K9 Haskell — See README.adoc for details.
...
----
# Clone and set up
git clone https://github.com/hyperpolymath/k9-haskell.git
cd k9-haskell
just setup
----
...
[source,bash]
----
just install --portable --prefix=./k9-haskell-portable
----
...
[source]
----
K9 Haskell started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/k9-haskell/wiki
